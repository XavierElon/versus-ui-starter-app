export const requirementsData = [
  ...
  },
  {
    ...
    content:
      'You can access the withdrawal page on the website or by pressing the drop down menu in the top right corner of the app, then click the "Withdraw" button. Enter your withdrawal info, including how much money you want to withdraw. Then click the "Request Withdrawal" button.'
  },
  {
    id: 5,
    title: 'How do I cancel my withdrawal?',
    content:
