...
export class ErrorMessage {
  ...
  constructor() {
    ...
    this.firstName =
      'First name must contain only letters, and must be between 2 - 30 characters and have no spaces'
    this.lastName =
      'Last name must contain only letters, and must be between 2 - 30 characters and have no spaces'
  }
}
